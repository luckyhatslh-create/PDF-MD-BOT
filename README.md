...
## ✨ Основные обновления (v2.1)

### Новые возможности качества PDF→MD конвертации

- **🔍 Smart Table Detection**: Многофакторный анализ таблиц с отклонением сломанных структур
  - Детектирование фрагментации ячеек (разорванные слова)
  - Проверка консистентности столбцов
  - Обнаружение разбитых предложений
- **🗑️ Garbage Line Filtering**: Автоматическая фильтрация мусорных строк
  - Числовой шум (артефакты PDF)
  - Повторяющиеся одиночные символы
  - Символьные линии и некорректный Unicode
- **🔄 Text/Table Deduplication**: n-граммный анализ для предотвращения дублирования
- **📝 Numbered List Correction**: Корректное различение нумерованных списков и заголовков
- **📊 Quality Metrics**: Подробная статистика обработки документа

### Предыдущие обновления (v2.0)
